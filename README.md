...
From time to time I will update this repo and document my attempts to decrease the binary size and increase efficiency. What I wrote above was just... a "brief" summary. From now on, future updates will include technical details, screenshots, benchmark results etc. for better understanding.
